...
class _CurrencySelectionScreenState extends State<CurrencySelectionScreen> {
      ...
      body: ListView.builder(
        ...
        itemBuilder: (final context, final index) {
          ...
          return ListTile(
            ...
            trailing: widget.selectedCurrencyCode == currency.code
  ...
  void _filterCurrencies(final String query) {
    if (query.isEmpty) {
      ...
      final filtered = _allCurrencies.where((final currency) => currency.name.toLowerCase().contains(query.toLowerCase()) ||
               currency.code.toLowerCase().contains(query.toLowerCase()) ||
               currency.symbol.toLowerCase().contains(query.toLowerCase())).toList();
